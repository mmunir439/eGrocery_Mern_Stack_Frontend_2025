...
export default function Bakkery() {
  let allproductsarray=[
    ...
    {
      img:"/images/patisabakkery.webp",
      name:"Patisserie",
      desc:"Freshly Baked Patisserie",
      rating:0,
      star:5,
      price:35,
      oldprice:40
    ...
    {
      img:"/images/sohnhalwa.webp",
      name:"Sohn Halwa",
      desc:"Freshly Made Sohn Halwa",
      rating:0,
      star:5,
      price:35,
      oldprice:40
