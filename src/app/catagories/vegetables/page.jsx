  ...
  return (
    <div>
      ...
      <div className="text-3xl font-bold m-3 mt-10 mb-5 text-center">
               <h1>All types of <span className="text-green-500 underline">Vegetables</span></h1>
      </div>
       <div className="grid md:grid-cols-5 grid-cols-1 mb-20">
        {allproductsarray.map((item,index)=>(
          <div key={index} className="border gap-3 mr-6 justify-center w-[250px] h-[350px] flex flex-col items-center m-2 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
